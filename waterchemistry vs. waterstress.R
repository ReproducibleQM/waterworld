...
#merged all regions abck to one dataset
REGnars<-rbind(regNARS1,regNARS2,regNARS3,regNARS4,regNARS5,regNARS6)
...
#region 4
#percent forest
plot(regNARS4$PFOR, regNARS4$SIMPSON)
plot(regNARS4$PFOR, regNARS4$EPT_PTAX)
plot(regNARS4$PFOR, regNARS4$EPT_PIND)
plot(regNARS4$PFOR, regNARS4$NH4)
plot(regNARS4$PFOR, regNARS4$pH)
plot(regNARS4$PFOR, regNARS4$NH4norm)
#percent wetland
plot(regNARS4$PWETL, regNARS4$SIMPSON)
plot(regNARS4$PWETL, regNARS4$EPT_PTAX)
plot(regNARS4$PWETL, regNARS4$EPT_PIND)
plot(regNARS4$PWETL, regNARS4$NH4)
plot(regNARS4$PWETL, regNARS4$pH)
plot(regNARS4$PWETL, regNARS4$NH4norm)
#percent urban
plot(regNARS4$PURB, regNARS4$SIMPSON)
plot(regNARS4$PURB, regNARS4$EPT_PTAX)
plot(regNARS4$PURB, regNARS4$EPT_PIND)
plot(regNARS4$PURB, regNARS4$NH4)
plot(regNARS4$PURB, regNARS4$pH)
plot(regNARS4$PURB, regNARS4$NH4norm)
#percent agrculture
plot(regNARS4$PAGT, regNARS4$SIMPSON)
plot(regNARS4$PAGT, regNARS4$EPT_PTAX)
plot(regNARS4$PAGT, regNARS4$EPT_PIND)
plot(regNARS4$PAGT, regNARS4$NH4)
plot(regNARS4$PAGT, regNARS4$pH)
plot(regNARS4$PAGT, regNARS4$NH4norm)

#region 5
#percent forest
plot(regNARS5$PFOR, regNARS5$SIMPSON)
plot(regNARS5$PFOR, regNARS5$EPT_PTAX)
plot(regNARS5$PFOR, regNARS5$EPT_PIND)
plot(regNARS5$PFOR, regNARS5$NH4)
plot(regNARS5$PFOR, regNARS5$pH)
plot(regNARS5$PFOR, regNARS5$NH4norm)
#percent wetland
plot(regNARS5$PWETL, regNARS5$SIMPSON)
plot(regNARS5$PWETL, regNARS5$EPT_PTAX)
plot(regNARS5$PWETL, regNARS5$EPT_PIND)
plot(regNARS5$PWETL, regNARS5$NH4)
plot(regNARS5$PWETL, regNARS5$pH)
plot(regNARS5$PWETL, regNARS5$NH4norm)
#percent urban
plot(regNARS5$PURB, regNARS5$SIMPSON)
plot(regNARS5$PURB, regNARS5$EPT_PTAX)
plot(regNARS5$PURB, regNARS5$EPT_PIND)
plot(regNARS5$PURB, regNARS5$NH4)
plot(regNARS5$PURB, regNARS5$pH)
plot(regNARS5$PURB, regNARS5$NH4norm)
#percent agrculture
plot(regNARS5$PAGT, regNARS5$SIMPSON)
plot(regNARS5$PAGT, regNARS5$EPT_PTAX)
plot(regNARS5$PAGT, regNARS5$EPT_PIND)
plot(regNARS5$PAGT, regNARS5$NH4)
plot(regNARS5$PAGT, regNARS5$pH)
plot(regNARS5$PAGT, regNARS5$NH4norm)

#region 6
#percent forest
plot(regNARS6$PFOR, regNARS6$SIMPSON)
plot(regNARS6$PFOR, regNARS6$EPT_PTAX)
plot(regNARS6$PFOR, regNARS6$EPT_PIND)
plot(regNARS6$PFOR, regNARS6$NH4)
plot(regNARS6$PFOR, regNARS6$pH)
plot(regNARS6$PFOR, regNARS6$NH4norm)
#percent wetland
plot(regNARS6$PWETL, regNARS6$SIMPSON)
plot(regNARS6$PWETL, regNARS6$EPT_PTAX)
plot(regNARS6$PWETL, regNARS6$EPT_PIND)
plot(regNARS6$PWETL, regNARS6$NH4)
plot(regNARS6$PWETL, regNARS6$pH)
plot(regNARS6$PWETL, regNARS6$NH4norm)
#percent urban
plot(regNARS6$PURB, regNARS6$SIMPSON)
plot(regNARS6$PURB, regNARS6$EPT_PTAX)
plot(regNARS6$PURB, regNARS6$EPT_PIND)
plot(regNARS6$PURB, regNARS6$NH4)
plot(regNARS6$PURB, regNARS6$pH)
plot(regNARS6$PURB, regNARS6$NH4norm)
#percent agrculture
plot(regNARS6$PAGT, regNARS6$SIMPSON)
plot(regNARS6$PAGT, regNARS6$EPT_PTAX)
plot(regNARS6$PAGT, regNARS6$EPT_PIND)
plot(regNARS6$PAGT, regNARS6$NH4)
plot(regNARS6$PAGT, regNARS6$pH)
plot(regNARS6$PAGT, regNARS6$NH4norm)
